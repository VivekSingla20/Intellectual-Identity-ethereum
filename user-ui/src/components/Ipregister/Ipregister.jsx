...
const Ipregister = () => {
  ...
  return (
    <>
      ...
      <div>
        <a
          class="arrow mb-6 bg-gradient-to-r from-black via-gray-300"
          onClick={routeChange}
        >
          Back
        </a>
      ...
      >
        <form className="ipform px-5 mx-20 my-16 bg-white flex">
          <div className="fields">
            <div className="mb-6 py-3 text-black">
              <h1>Register IP</h1>
            </div>
            <div className="">
              <div className="mb-4">
                <label className="text-xl">IP Name </label>
                <br></br>
                <input
                  className="ip-box text-gray-700 border py-2 px-2 rounded"
                  placeholder="your material name"
                  type="text"
                  name="user"
                  onChange={(e) =>
                    updateFormParams({ ...formParams, IPname: e.target.value })
                  }
                  value={formParams.IPname}
                />
              </div>
              <div className="mb-4">
                ...
                <input
                  ...
                  className="ip-box text-gray-700 border py-2 px-2 rounded"
                  name="IPname"
                  placeholder="your material description"
                  onChange={(e) =>
                    updateFormParams({
                      ...formParams,
              ...
              <div className="mb-4">
                <label className="text-xl">Country Name</label>
                <br></br>
                <input
                  className="ip-box text-gray-700 border py-2 px-2 rounded"
                  type="text"
                  ...
                  onChange={(e) =>
                    updateFormParams({ ...formParams, country: e.target.value })
                  }
          ...
          <div className="fields second-box mt-28 px-4 ml-6">
            <div className="mb-4 second-lab">
              <label className="text-xl">Street Name</label>
              <br></br>
              <input
                className="ip-box text-gray-700 border py-2 px-2 rounded"
                type="text"
                ...
                onChange={(e) =>
                  updateFormParams({ ...formParams, street: e.target.value })
                }
