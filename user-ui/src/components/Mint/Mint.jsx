...
const Mint = (props) => {
  ...
  return (
    <>
      ...
      <div>
        <a
          class="arrow mb-4 bg-gradient-to-r from-black via-gray-300"
          onClick={routeChange}
        >
          Back
        </a>
      ...
      >
        <form className="form-status status-form text-black px-5 mx-20 my-16 bg-white">
          <div className="text-center fields mx-28">
            <div className="mb-6 py-3 text-xl">
              <h1>Mint Nft'</h1>
            </div>
            <div className="">
              <div className="mb-4">
                <label className="text-xl">IP id </label>
                <br></br>
                <input
              ...
              <div className="mb-4">
                <label className="text-xl">Approved Address</label>
                <br></br>
                <input
                  className="input-box text-gray-700 border py-2 px-2 rounded"
                  type="text"
              ...
              <div className="mb-4">
                <label className="text-xl">Ip data url</label>
                <br></br>
                <input
                  className="input-box text-gray-700 border py-2 px-2 rounded"
                  type="text"
              ...
              <div className="py-3">
                <button
                  ...
                  className="w-32 text-white text-lg rounded py-4 bg-black cursor-pointer"
                >
                  Mint
                </button>
              </div>
