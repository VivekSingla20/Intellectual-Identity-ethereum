...
const Bidregister = (props) => {
  ...
  return (
    <>
      ...
      <div>
        <a
          className="arrow mb-6 bg-gradient-to-r from-black via-gray-300"
          onClick={routeChange}
        >
          Back
        </a>
      ...
      >
        <form className="bidform px-5 mx-20 mt-28 bg-white flex justify-center">
          <div className="fields px-10">
            <div className="mb-6 py-3 text-center text-sm text-black">
              <h1>Register IP Bidders'</h1>
            </div>
            <div className="">
              <div className="mb-4">
                <label className="text-xl">IP owner public address</label>
                <br></br>
                <input
                  ...
                  type="text"
                  name="address"
                  placeholder="ip owner public address"
                />
              </div>

              <div className="mb-4">
                <label className="text-xl">Owners' IP Name</label>
                <br></br>
                <input
                  className="input-box text-gray-700 border py-2 px-2 rounded"
                  ref={ipname}
                  ...
                  type="text"
                  name="ownerIPname"
                  placeholder="owner intellectual property name"
                />
              </div>

              <div className="mb-4">
                <label className="text-xl">Bidding Value</label>
                <br></br>
                <input
                  className="input-box text-gray-700 border py-2 px-2 rounded"
                  ref={bidval}
