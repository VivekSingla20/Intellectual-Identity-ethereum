    ...
    <>
        ...
        <div className="homecontain" data-testid="section-one">
          <div className="">
            ...
            <p className="mt-4 text-white m-2">
              Prevent others from using yours' invention and when you want you
              can transfer your invention to others by selling it.
            </p>
            <button
            ...
            cursor-pointer text-white text-xl mr-2 mt-2 mb-10
            hover:brightness-125 shadow-lg"
            >
              Connect Wallet
            </button>
          </div>
      ...
      <div className="sect-one absolute ">
        <div className="titlehead text-center my-64 mx-64">
          <h1 className="text-center text-5xl font-serif">
            Intellectual property management on the blockchain
          </h1>
        </div>
      ...
      <div className="text-center content p-20 bg-gray-100">
        ...
        <div className="text-center">
          ...
          <NavLink to={{ pathname: `/ipregister` }}>
            ...
            py-4 px-8 rounded text-white text-xl hover:brightness-105 shadow-lg"
            >
              Register
            </button>
          </NavLink>
      ...
      <div className="flex flex-wrap justify-center my-28">
        <img
          src={guerlia}
          alt=""
          className="h-96 w-96 border rounded-lg shadow-lg shadow-gray-500/50"
        />
        <img
          src={miladfak}
          alt=""
          className="secimg h-96 w-96 ml-2 mt-7 phot2 border rounded-lg shadow-xl shadow-gray-500/50"
        />
        <img
          src={nenad}
          alt=""
          className="thirimg h-96 w-96 ml-2 border rounded-lg shadow-lg shadow-gray-500/50"
        />
        {/* <div className='absolute bg-gray-900 w-full opacity-25 h-96 '></div> */}
      </div>
