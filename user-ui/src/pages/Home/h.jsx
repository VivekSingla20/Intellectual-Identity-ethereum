        ...
        <div className="homecontain" data-testid="section-one">
          <div className="first">
            <h1 className="italic text-white md:text-sm">
              <strong className="italic text-white md:text-sm">
                Mark your business name and logo for life
              </strong>
            </h1>
            <p className="mt-4 text-white m-2 md:text-sm">
              Prevent others from using yours' invention and decide who is
              allowed to produce, sell or import your invention.
            </p>
            <button
