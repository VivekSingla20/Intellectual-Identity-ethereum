...
const Mybidding = () => {
  const { connectWallet, currentAccount, countbids } =
    ...
    <>
      ...
      <div className="bg-white">
        <p className="text-center text-gray-400 mb-16">
          connect to your wallet, to see your IP bidders'
        </p>
      </div>
      ...
      {bidsData.length == 0 ? (
        <p className="text-center">You have not made any bids, yet</p>
      ) : null}
      {bidsData.length != 0 ? (
        <MyBidstable data={search(bidsData)} />
      ) : (
        <Loader />
      )}
    </>
