...
import { Iptable, Loader } from "../../components/index";
    ...
    <>
      <div className="mb-96 mt-20">
        ...
        <div className="flex justify-between">
          <p className="mx-4 py-4 text-3xl cursor-pointer">
        ...
        <div className="flex flex-wrap gap-14 mx-5 ml-12 mb-10 my-5">
          <div className="box hover:brightness-105 transition duration-150 ease-out hover:ease-in border border-10 border-gray-300 rounded-lg bg-white w-56 p-2">
            <h3 className="text-sm text-gray-600 flex justify-between">
              {" "}
              Total Ips <FaHourglass className="text-black text-3xl" />
            </h3>
            <br></br>
            <span className="text-bold text-black text-4xl">
              {pend + accept + reject}
            </span>
          </div>
          <div className="box hover:brightness-105 transition duration-150 ease-out hover:ease-in border border-10 border-gray-300 rounded-lg bg-white w-56 p-2">
            <h3 className="text-sm text-gray-600 flex justify-between">
              {" "}
              Total Pendings <FaHourglass className="text-black text-3xl" />
            </h3>
            <br></br>
            <span className="text-bold text-black text-4xl">{pend}</span>
          </div>
          <div className="box hover:brightness-105 transition duration-150 ease-out hover:ease-in border border-10 border-gray-300 rounded-lg bg-white w-56 p-2">
            <h3 className="text-sm text-gray-600 flex justify-between">
              {" "}
              Total Approves
              <FaHourglass className="text-black text-3xl" />
            </h3>
            <br></br>
            <span className="text-bold text-black text-4xl">{accept}</span>
          </div>
          <div className="box hover:brightness-105 transition duration-150 ease-out hover:ease-in border border-10 border-gray-300 rounded-lg bg-white w-56 p-2">
            <h3 className="text-sm text-gray-600 flex justify-between text-sm">
              {" "}
              Total Rejects <FaHourglass className="text-black text-3xl" />
            </h3>
            <br></br>
            <span className="text-bold text-black text-4xl">{reject}</span>
          </div>
        </div>
